...
import 'package:krushant_demo/theme/font_style.dart';

class CustomGetXTheme {
  static ThemeData get lightTheme => ThemeData(
      ...
      navigationBarTheme: NavigationBarThemeData(
          labelTextStyle: MaterialStatePropertyAll(CustomGetXFontStyle
              .primaryTextTheme.labelMedium
              ?.copyWith(fontSize: 16)),
          labelBehavior: NavigationDestinationLabelBehavior.alwaysShow,
          backgroundColor: Colors.white),
      bottomNavigationBarTheme: BottomNavigationBarThemeData(
          unselectedLabelStyle: CustomGetXFontStyle.primaryTextTheme.labelMedium
              ?.copyWith(
          ...
          selectedLabelStyle: CustomGetXFontStyle.primaryTextTheme.labelMedium
              ?.copyWith(
                  fontWeight: FontWeight.normal,
                  fontSize: 16,
                  color: primaryTextColor)),
      appBarTheme: appBarTheme,
      textTheme: CustomGetXFontStyle.primaryTextTheme,
      primaryTextTheme: CustomGetXFontStyle.primaryTextTheme,
